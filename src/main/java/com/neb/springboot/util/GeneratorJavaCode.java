package com.neb.springboot.util;
...
/**
 * 生成controller、service、serviceImpl、dao、daoImpl、request
 * Copyright: Copyright (c) 2019
 *
 * @ClassName: GeneratorJavaCode
 * @Description:
 * @version: v1.0.0
 * @author: niueb
...
public class GeneratorJavaCode {
     ...
     * 是否覆盖更新.
     */
    private static final Boolean isFileOverride = false;
    /**
     * 注释作者
     */
     ...
     * 项目根包名称.
     */
    private static final String projectPlublicPackageName = "\\src\\main\\java";
    private static final String busiPackageName = "com.neb.springboot";
    /**
     * 模块名称
     */
    private static final String javaClassPreffixName = "User";//修改


    public static void main(String[] args) {
        String[] tableNames = new String[]{"user"};//修改
    ...
    private static GlobalConfig getGlobalConfig(String module) {
        ...
        String outputDir = absolutePath + projectPlublicPackageName;
        ;
    ...
    private static PackageConfig getPackageConfig(String module) {
        ...
        String packageName = busiPackageName;
